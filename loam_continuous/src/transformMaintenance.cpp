...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subOdomBefMapped = nh.subscribe<nav_msgs::Odometry>("/bef_mapped_to_init_2", 5, odomBefMappedHandler);

  ros::Subscriber subOdomAftMapped = nh.subscribe<nav_msgs::Odometry>("/aft_mapped_to_init_2", 5, odomAftMappedHandler);
